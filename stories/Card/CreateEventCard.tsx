  ...
  return (
    <div className="max-w-md group transition-colors duration-200 bg-white border-[3px] border-dashed border-secondary-100 hover:bg-secondary-50 rounded-2xl">
      <Link href="/event/create">
        <a className="flex flex-col items-center justify-center w-full h-full text-xl font-semibold transition-colors duration-200  focus:outline-offset-2 rounded-2xl group-hover:text-secondary-500 text-secondary-400">
