  ...
  return (
    <section className="flex flex-col justify-between flex-1 w-screen h-full bg-white">
      ...
      <div className="grid lg:grid-cols-12">
        <div className="w-full px-10 md:flex md:justify-center lg:bg-primary-50 lg:h-screen lg:col-start-6 lg:col-span-7">
          <Image
            src={homeImage}
        ...
        <div className="flex flex-col justify-center p-4 lg:justify-between md:p-8 lg:px-10 lg:h-screen lg:col-start-1 lg:row-start-1 lg:col-span-5">
          <div className="hidden w-full py-12 lg:flex">
            <Logo />
          </div>
          <div className="flex flex-col gap-4">
            <p className="text-4xl font-semibold text-textGray">
